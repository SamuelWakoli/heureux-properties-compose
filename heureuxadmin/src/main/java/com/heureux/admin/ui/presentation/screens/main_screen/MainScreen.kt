...
fun MainScreen(
    ...
    Scaffold(topBar = {
        ...
        if (bottomNavController.currentBackStackEntryAsState().value?.destination?.route == Screens.HomeScreen.route) FloatingActionButton(
            onClick = {
                homeScreenViewModel.updateCurrentPropertyState(null)
